...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Ajouter ADMIN - Admin </title>
    ...
    <script type="text/javascript">
        function valid(){
            ...
            alert("Nouveau MDP et Confirme MDP champs ne sont pas compatible  !!");
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="manage-admin.php">Géstion d'Administration</a></li>
					...
					<div class="row">
						...
						<?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
							...
							<div class="card">
                                ...
                                <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d'ajouter un nouvel administrateur au système.</p>
								...
								<div class="card-body">
									<form name="addemp" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nom Complet</label>
                                        ...
                                        <h4>Configuration des Mots de Passe :</h4>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Confirmation Mot de Passe</label>
                                            <input class="form-control" name="confirmpassword" type="password" autocomplete="off" required>
                                        </div>

                        

                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">Ajoutez</button>
