...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Tableau de bord - Admin </title>
            ...
            <div class="header">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a class="dropdown-item" href="logged.php">Déconnexion</a>
					</div>
				</div>
				<!-- /Mobile Menu -->
							...
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php include 'counters/emp-counter.php'?></h3>
										<span>Employés</span>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php include 'counters/emp-counter-innactive.php'?></h3>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php include 'counters/dept-counter.php'?></h3>
						...
						<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
							<div class="card dash-widget">
								<div class="card-body">
									...
									<div class="dash-widget-info">
										<h3><?php include 'counters/leavetype-counter.php'?></h3>
										<span>Types Congé</span>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 d-flex">
							<div class="card card-table flex-fill">
								<div class="card-header">
									<h3 class="card-title mb-0">Dernières Demandes Congés</h3>
								</div>
								<div class="card-body">
									...
									<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
											...
											<?php 
												...
												<tr>
													...
													<td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">Voir Détails</a></td>
								...
								<div class="card-footer">
									<a href="leave-history.php">Voir Tous</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12 d-flex">
							<div class="card card-table flex-fill">
								...
								<div class="card-footer">
									<a href="employees.php">Voir Tous</a>
								</div>
							</div>
						</div>
