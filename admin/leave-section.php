...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Types Congés - Admin </title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Section Des Congés</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Acceuil</a></li>
									<li class="breadcrumb-item active">Gérer Les Types De Congés</li>
								</ul>
							</div>
							<div class="col-auto float-right ml-auto">
								<a href="add-leavetype.php" class="btn add-btn"><i class="fa fa-plus"></i> Ajouter Un Type De Congé</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
						...
						<div class="col-md-12 d-flex">
							...
							<?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
								...
								<div class="card-header">
									<h3 class="card-title mb-0">Liste Des Types De Congés</h3>
								</div>
								<div class="card-body">
									...
									<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->CreationDate);?></td>
													<td class="text-center"><a href="edit-leaveType.php?lid=<?php echo htmlentities($result->id);?>"><i class="fa fa-pencil m-r-5" ></i></a><a href="leave-section.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a></td>
												</tr>
												<?php $cnt++;} }?>
											</tbody>
										</table>
