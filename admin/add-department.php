...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Ajouter Department - Admin </title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="department.php">Département</a></li>
						...
						<?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
							...
							<div class="card">
								<div class="card-header">
									<p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d'ajouter un nouveau département.</p>
									
								</div>
								<div class="card-body">
									<form name="addemp" method="POST">
									<div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nom Département</label>
