...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Mise à jour Département - Admin </title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Section Départment </h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="department.php">Départment</a></li>
						...
						<?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
							...
							<div class="card">
								<div class="card-header">
									<p class="text-muted font-14 mb-4">Veuillez effectuer les changements sur le formulaire ci-dessous afin de mettre à jour le département</p>
								...
								<div class="card-body">
									...
									<div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nom Départment</label>
