...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Department - Admin </title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Section Département</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashboard.php">Accueil</a></li>
									<li class="breadcrumb-item active">Gestion du Département</li>
								</ul>
							</div>
							<div class="col-auto float-right ml-auto">
								<a href="add-department.php" class="btn add-btn"><i class="fa fa-plus"></i> Ajouter Département</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
									...
									<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
											...
											{               ?>  
												<tr>
													...
													<td class="text-center"><a href="edit-department.php?deptid=<?php echo htmlentities($result->id);?>"><i class="fa fa-pencil m-r-5" ></i></a><a href="department.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you want to delete');"> <i class="fa fa-trash" style="color:red"></i></a></td>
												</tr>
												<?php $cnt++;} }?>
											</tbody>
										</table>
