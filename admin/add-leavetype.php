...
<html lang="en">
    <head>
        ...
        <title>OUMDIN Add Leave Type - Admin </title>
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="leave-section.php">Gérer les type de Congés</a></li>
									<li class="breadcrumb-item active">Ajouter Congé</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
							...
							<div class="card">
								<div class="card-header">
									<p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d'ajouter un nouveau type de congé.</p>
									
								</div>
								<div class="card-body">
									<form method="POST">
									<div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Type Congé</label>
                                        ...
                                        <button class="btn btn-primary" name="add" id="add" type="submit">Ajouter</button>
